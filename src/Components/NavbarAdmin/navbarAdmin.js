                ...
                <div className="container col-5 AdminNavbar">
                    <nav id="nav nav-pills nav-justified">
                        <ul className="d-flex justify-content-between">
                            ...
                            <Link className="NavBarAdmin_navLink NavBarAdmin_navLink--orange global_bgColor--orange"><img src={process.env.PUBLIC_URL + labelIcone} className="AdminNavbar_link_img" alt=""/></Link>
